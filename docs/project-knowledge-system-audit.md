...
3. 用户先打开中文功能分类目录草稿审核，再逐份审核两层开发指导；
...
上述两份文档从 0.1.19 起取代本报告原“0.1 最小需求收敛决议”，成为 0.1.20 功能开发的直接基线。下方 0.1 节保留为 0.1.15 阶段的历史决议，不再约束当前功能范围。
