...
> 当前版本：0.1.27
> 复核日期：2026-08-14  
> 报告状态：0.1.27 WP-11 交付闭环、CodeGraph 主链路与检索精度复核
> 默认语言：中文

## 当前交付复核：WP-11

本节是 0.1.27 的当前验收结论；下方较早版本的工作包和里程碑记录仅用于历史追溯。
...
| RET-006 | 已完成 | 40 题正式评测通过：code 召回率/精确率 `0.94375/0.204699`，hybrid `0.960417/0.170549`，Markdown `0.902083/0.24375`，grep `0.689583/0.294167`；未降低既有召回门槛 |
